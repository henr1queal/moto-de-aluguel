                ...
                <form>
                    ...
                    <div class="row g-3 mt-3">
                        <div class="col mt-0">
                            ...
                            <input type="text" class="form-control bg-transparent" id="brand" value="{{ $vehicle->brand }}" name="brand">
                        </div>
                        <div class="col mt-0">
                            <label for="model" class="form-label fw-light">Modelo<span
                                    class="text-danger"><strong>*</strong></span></label>
                            <input type="text" class="form-control bg-transparent" id="model" value="{{ $vehicle->model }}" name="model">
                        </div>
                    </div>
                    <div class="row g-3 mt-3">
                        <div class="col mt-0">
                        ...
                        <div class="col mt-0">
                            <label for="renavam" class="form-label fw-light">Renavam<span
                                    class="text-danger"><strong>*</strong></span></label>
                            <input type="text" class="form-control bg-transparent" id="renavam" value="{{ $vehicle->renavam }}" name="renavam">
                        </div>
                    </div>
                    <div class="row g-3 mt-3">
                        <div class="col mt-0">
                            <label for="year" class="form-label fw-light">Ano modelo<span
                                    class="text-danger"><strong>*</strong></span></label>
                            <input type="text" class="form-control bg-transparent" id="year" value="{{ $vehicle->year }}" name="year">
                        </div>
                        <div class="col mt-0">
                            <label for="actual_km" class="form-label fw-light">KM Atual<span
                                    class="text-danger"><strong>*</strong></span></label>
                            <input type="text" class="form-control bg-transparent" id="actual_km" value="{{ $vehicle->oil_period }}" name="oil_period">
                        </div>
                        <div class="col mt-0">
                    ...
                    <div class="row g-3 mt-3">
                        <div class="col mt-0">
                            ...
                            <input type="text" class="form-control bg-transparent" id="revision_period"
                                value="{{ $vehicle->revision_period }}" name="revision_period">
                        ...
                        <div class="col mt-0">
                            <label for="oil_period" class="form-label fw-light">Período troca de óleo<span
                                    class="text-danger"><strong>*</strong></span></label>
                            <input type="text" class="form-control bg-transparent" id="oil_period" value="{{ $vehicle->oil_period }}" name="oil_period">
                            <div id="emailHelp" class="form-text text-secondary">Quilômetros</div>
                        </div>
                    </div>
                </form>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            document.querySelectorAll('.vehicle').forEach(vehicle => {
                vehicle.addEventListener('click', () => {
                    const input = vehicle.querySelector('input[value="{{ $vehicle->vehicle_id }}" name="vehicle_id"]');
                    if (input) {
                        input.checked = true;
                    }
                });
