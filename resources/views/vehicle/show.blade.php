...
@section('content')
    ...
    <div class="container">
                ...
                <form action="{{ route('vehicle.update', $vehicle->id) }}" method="POST" onsubmit="disableSubmit()">
                    ...
                    <div class="row g-3 mt-5 mb-5">
                        <div class="col mt-0 text-center">
                            <button type="submit" class="btn btn-success btn-lg" id="submit"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-arrow-repeat me-1" viewBox="0 0 16 16">
        ...
        <div class="row mt-4">
            <div class="col">
                <form action="{{ route('vehicle.delete', ['vehicle' => $vehicle->id]) }}" method="post" onsubmit="return confirm('Tem certeza que deseja deletar este veículo?');">
                    @csrf
                    @method('DELETE')
                    <button type="submit" class="btn-sm btn btn-danger"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-trash me-1" viewBox="0 0 16 16">
