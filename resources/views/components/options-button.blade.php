<div class="container text-end">
    <div class="btn-group dropup-center dropup mt-2">
        <button type="button" class="btn btn-light fs-1 py-0 rounded-3" data-bs-toggle="dropdown" aria-expanded="false">
            <strong>+</strong>
        </button>
        <ul class="dropdown-menu p-2 text-center shadow mb-1" style="width: auto; min-width: 70px;">
            <li>
                <a href="#" class="d-block text-decoration-none text-black">
                    <img src="{{ asset('assets/svg/multa.svg') }}" alt="Icon 1" class="img-fluid mx-auto" style="width: 30px; height: auto;">
